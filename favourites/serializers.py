...
class FavouritesSerializer(serializers.ModelSerializer):
    ...
    wifi_location_image = serializers.ImageField(
        source='wifi_location.image', read_only=True
    )
    ...
    wifi_location_id_display = serializers.ReadOnlyField(
        source='wifi_location.id'
    )

    class Meta:
        model = Favourites
        fields = [
            'id', 'user', 'wifi_location_id', 'wifi_location_id_display',
